...
stats_button = InlineKeyboardButton(text='Статитика', callback_data='stats')
matches_button = InlineKeyboardButton(text='Матчи', callback_data='matches')
last_matches_stats_button = InlineKeyboardButton(text='За последние 20 матчей', callback_data='matches')
